            ...
            <div className='flex items-center gap-4 '>
                    ...
                    token ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                        ...
                        <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                            <div className='min-w-48 bg-[#eee] rounded flex flex-col gap-4 p-4'>
                                ...
                                <p onClick={()=>navigate('my-appontments')} className='hover:text-black cursor-pointer'>Tanlovlarim</p>
                ...
                <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0 '} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                  ...
                  <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium '>
                    ...
                    <NavLink  onClick={()=>setShowMenu(false)} to={'/about'}><p className='px-4 py-2 rounded  inline-block'>Aboot</p></NavLink>
